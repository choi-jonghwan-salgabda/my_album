...
class configger:
    ...
    def __init__(self, config_path: str):
        ...
        logger.debug(f"1. __init__ config_path : {config_path}")
    ...
    def _resolve_placeholders(self, config: dict, context: dict) -> dict:
        ...
        logger.debug(f"0. raw_config : {raw_config}")
    ...
    def _load_and_resolve_config(self) -> dict:
        ...
        """
        logger.debug(f"_load_and_resolve_config : {self.config_path}")
        ...
        logger.debug(f"1. raw_config : {raw_config}")
