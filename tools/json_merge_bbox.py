...
def merge_tl1_jsons(json_root, output_path):
    merged = {}
...
# TL1 데이터셋의 JSON 파일들을 병합하여 train_labels.json 파일로 저장
merge_tl1_jsons(data_path, "train_labels.json")
